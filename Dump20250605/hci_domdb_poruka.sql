...
CREATE TABLE `poruka` (
  ...
  `EmailPosiljaoca` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `BrTelefonaPosiljaoca` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `TekstPoruke` text COLLATE utf8_unicode_ci NOT NULL,
  `VrijemeIDatumSlanja` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
